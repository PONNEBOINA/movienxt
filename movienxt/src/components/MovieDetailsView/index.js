  ...
  const getMovieDetails = async () => {
    ...
    if (response.ok) {
      ...
      const updatedData = {
        ...
        trailerUrl: data.movie_details.trailer_url || 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
      }
      ...
      setTrailerUrl(updatedData.trailerUrl)
